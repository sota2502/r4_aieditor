...
class RatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post rates_url, params: { rate: { action_state_id: @rate.action_state_id, name: @rate.name, value: @rate.value } }
    end
  ...
  test "should update rate" do
    patch rate_url(@rate), params: { rate: { action_state_id: @rate.action_state_id, name: @rate.name, value: @rate.value } }
